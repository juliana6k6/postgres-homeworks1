...
select * into dicontinued_products from products where discontinued = 1
...
-- Удаляем продукты, снятые с продажи в таблице orders:
DELETE FROM products WHERE discontinued = 1;

-- Удаляем продукты, снятые с продажи, в таблице order_details:
